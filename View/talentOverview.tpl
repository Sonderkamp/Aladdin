                                    ...
                                    <div>
                                        <nav>
                                            <ul class="pagination">
                                                ...
                                                {else}
                                                    <li>
                                                        <a href="/talents/p=m/m={$current_user_talent_number - 1}/a={$current_talent_number}/t={$current_requested_talent_number}"
                                                           aria-label="Previous">
                                                            <span aria-hidden="true">&laquo;</span>
                                                        </a>
                                                    </li>
                                                ...
                                                <div>
                                                    <nav>
                                                        <ul class="pagination">
                                                            ...
                                                            {else}
                                                                <li>
                                                                    <a href="/talents/p=a/m={$current_user_talent_number}/a={$current_talent_number - 1}/t={$current_requested_talent_number}"
                                                                       aria-label="Previous">
                                                                        <span aria-hidden="true">&laquo;</span>
                                                                    </a>
                                                                </li>
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            {elseif !empty($added_talent_warning)}
                                                                <div class="alert alert-success alert-dismissible"
                                                                    ...
                                                                    <strong>Talent
                                                                        toegevoegd!</strong> {$added_talent_warning}
                                                                </div>
                                                            {/if}
                                                                ...
                                                                <div>
                                                                    <nav>
                                                                        <ul class="pagination">
                                                                            ...
                                                                            {else}
                                                                                <li>
                                                                                    <a href="/talents/p=t/m={$current_user_talent_number}/a={$current_talent_number}/t={$current_requested_talent_number - 1}"
                                                                                       aria-label="Previous">
                                                                                        <span aria-hidden="true">&laquo;</span>
                                                                                    </a>
                                                                                </li>
