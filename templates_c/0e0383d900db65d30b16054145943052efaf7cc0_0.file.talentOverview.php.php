<?php
/* Smarty version 3.1.29, created on 2016-03-06 19:22:02
  from "C:\xampp\htdocs\View\talentOverview.php" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56dc754ab44b10_59077326',
  'file_dependency' => 
  array (
...
function content_56dc754ab44b10_59077326 ($_smarty_tpl) {
?>
...
?>
                    <tr>
                        ...
                        <td class="col-sm-1">
                            <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal<?php echo preg_replace('/\s+/','',$_smarty_tpl->tpl_vars['talent']->value->name);?>
">
...
$__foreach_talent_3_saved_item = isset($_smarty_tpl->tpl_vars['talent']) ? $_smarty_tpl->tpl_vars['talent'] : false;
$_smarty_tpl->tpl_vars['talent'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['talent']->_loop = false;
foreach ($_from as $_smarty_tpl->tpl_vars['talent']->value) {
$_smarty_tpl->tpl_vars['talent']->_loop = true;
$__foreach_talent_3_saved_local_item = $_smarty_tpl->tpl_vars['talent'];
?>
<div id="myModal<?php echo preg_replace('/\s+/','',$_smarty_tpl->tpl_vars['talent']->value->name);?>
" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Talent toevoegen</h4>
            </div>
            <div class="modal-body">
                <p>
                    Weet u zeker dat u het talent "<?php echo $_smarty_tpl->tpl_vars['talent']->value->name;?>
...
"/>
                    <button type="submit" name="submit" class="btn btn-add btn-sm">
                        <span class="glyphicon glyphicon-ok"></span> Toevoegen
                    </button>
                </form>
            </div>
        </div>
...
<?php
$_smarty_tpl->tpl_vars['talent'] = $__foreach_talent_3_saved_local_item;
}
if ($__foreach_talent_3_saved_item) {
$_smarty_tpl->tpl_vars['talent'] = $__foreach_talent_3_saved_item;
}
}
}
